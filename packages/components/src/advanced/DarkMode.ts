...
export class DarkModeToggle extends Component<DarkModeToggleProps> {
  render(): string {
...
export function darkModeToggle(props?: DarkModeToggleProps): DarkModeToggle {
  return new DarkModeToggle(props || {});
}
