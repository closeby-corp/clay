...
(function() {
  ...
  function findCellByKey(table, rowId, colKey) {
    return table.querySelector('td[data-row-id="' + rowId + '"][data-col-key="' + colKey + '"]')
      || table.querySelector('tr[data-row-id="' + rowId + '"] td[data-col-key="' + colKey + '"]');
  }
